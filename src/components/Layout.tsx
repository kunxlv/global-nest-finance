...
export default function Layout({
  ...
  const NavItem = ({
    ...
    return <Link to={item.href} onClick={onClick} title={item.name} className="relative flex items-center justify-center w-12 h-12 group border-0">
  ...
  return <div className="flex min-h-screen bg-background">
      ...
      <main className="flex-1 w-full pt-14 lg:pt-0 lg:ml-[72px]">
        <div className="min-h-screen p-4 sm:p-6 lg:p-8 border-0 border-muted-foreground">
