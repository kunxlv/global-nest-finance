    ...
    <div className="flex flex-col h-full py-6">
      ...
      <div className="px-4 pt-4">
        <Link
          to="/settings"
          onClick={() => setMobileMenuOpen(false)}
          className="flex items-center gap-3 px-4 py-3 rounded-2xl text-muted-foreground hover:bg-card/50 hover:text-card-foreground transition-all duration-200"
        >
    ...
    <div className="flex min-h-screen bg-background">
      ...
      <aside className="hidden lg:flex w-[72px] bg-background py-6 flex-col fixed h-screen z-40">
        ...
        <div className="flex items-center justify-center mb-6">
          <h2 className="text-3xl sm:text-4xl font-bold text-foreground tracking-tight">f.</h2>
        </div>
